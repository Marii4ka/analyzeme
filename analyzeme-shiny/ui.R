  ...
  fluidPage(
    ...
    fluidRow(
      ...
      column(
        ...
        p("or"),
        checkboxInput("my_choices", "Use Example?", value=T),
        #selectInput("my_choices", "Example or Plot",choices = c("Plot", "Example"), selected = "Example"),
...
#         dataTableOutput('riskTable'),
        conditionalPanel(
          condition = "input.my_choices == T",
          uiOutput("allPCA.image")
           )#,
#         conditionalPanel(
